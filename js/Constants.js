const constants = {
    ...
    popover_img_urls: ["../images/rsz_keep-it-simple-blog.jpg", "../images/avatar2.jpg", "../images/avatar1.jpg","images/pen.png"],
    popover_img_ids: ["popover_img1", "popover_img2", "popover_img3","corner"],
    ...
    warnings: {
        canvas: {
            "3points": "The shape doesn't contain at least 3 points!!",
            "WrongURL": "Please enter a valid URL !"
        }
    }
};